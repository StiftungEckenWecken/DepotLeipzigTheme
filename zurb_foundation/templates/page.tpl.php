...
<div role="document" class="page">
      ...
      <nav class="top-bar" data-topbar <?php print $top_bar_options; ?>>
        <ul class="title-area">
          <li class="name">
           ...
           <a href="/"><img style="width:71px;" src="<?= base_path().path_to_theme(); ?>/images/logo.png" alt="Logo Depot Leipzig" /></a>
           </li>
        ...
        <section class="top-bar-section">
          <ul id="main-menu" class="main-nav left"><li class="first expanded has-dropdown">
            <li><select id="depot-global-select-kategorie" style="margin:4px 0 0 4px;">
  ...
  <!--.l-main -->
  <main role="main" class="row l-main" style="margin-top:40px;">
    <!-- .l-main region -->
