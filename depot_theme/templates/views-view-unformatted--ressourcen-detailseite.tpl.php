...
foreach ($resource as $res) :
	...
	$res['user']->is_organisation = (in_array(ROLE_ORGANISATION_NAME, $res['user']->roles) || in_array(ROLE_ORGANISATION_AUTH_NAME, $res['user']->roles));
    ...
    <form id="calResForm" method="GET"
          action="<?= (!user_is_logged_in() ? '/user/login?destination=/ressourcen/'.$res['type_id'] : '/reservierungen/neu') ?>">
